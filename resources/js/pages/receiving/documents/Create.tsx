                        ...
                        <section>
                            ...
                            <div className="space-y-6 pl-8">
                                ...
                                <div className="rounded-xl border border-amber-200 bg-amber-50 p-5">
                                    ...
                                    <div className={`mt-4 transition-all duration-300 ${isUrgent ? 'opacity-100 max-h-20' : 'opacity-0 max-h-0 overflow-hidden'}`}>
                                        <input
                                            type="text"
                                            value={data.urgency_justification}
                                            onChange={e => setData('urgency_justification', e.target.value)}
                                            placeholder="Reason for urgency..."
                                            className="h-10 w-full rounded-lg border border-amber-200 bg-white px-3 text-sm text-[var(--tng-slate-900)] placeholder:text-amber-400/70 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                                            required={isUrgent}
                                        />
                                    </div>
                                </div>
