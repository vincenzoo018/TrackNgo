                            ...
                            <section>
                                ...
                                <div className="space-y-5 pl-7">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <div className="h-9 w-full rounded-lg border border-[var(--tng-slate-200)] bg-[var(--tng-slate-50)] px-3 py-2 text-sm text-[var(--tng-slate-500)] cursor-not-allowed">
                                                {authUser?.department_name || 'System Generated'}
                                            </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                                        ...
                                        <label className="flex items-start gap-3 rounded-lg border border-[var(--tng-slate-200)] bg-white p-3 cursor-pointer transition-colors hover:border-[var(--tng-blue-300)] hover:bg-[var(--tng-blue-50)] shadow-sm">
                                            <input
                                                type="checkbox"
