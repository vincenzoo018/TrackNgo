...
export default function MayorSignatureSettings() {
    ...
    return (
        <TrackngoLayout>
            <Head title="Mayor E-Signature Settings — TrackNGo Mati" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between shrink-0 gap-4">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-[var(--tng-slate-500)]">
                            Configure your executive e-signature appearance and batch-signing PIN code.
                        </p>
                    </div>
                    {saved && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="rounded-xl border border-[var(--tng-slate-200)] bg-white p-6 shadow-sm">
                            ...
                            <p className="text-sm text-[var(--tng-slate-500)] mb-4">Use your mouse or touchscreen to draw your official executive signature.</p>
                            ...
                            <div className="flex justify-between mt-4">
                                <button onClick={clearCanvas} className="flex items-center gap-2 text-sm font-medium text-[var(--tng-slate-500)] hover:text-[var(--tng-slate-800)] cursor-pointer">
                                    <RotateCcw className="h-4 w-4" /> Clear Pad
                                </button>
                                <button onClick={handleSave} className="rounded-lg bg-[var(--tng-slate-900)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--tng-slate-800)] cursor-pointer">
                                    Save Signature
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl border border-[var(--tng-blue-200)] bg-[var(--tng-blue-50)]/50 p-6 shadow-sm">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[var(--tng-blue-700)]">Used to authorize bulk executive e-signature actions.</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 bg-white p-5 rounded-lg border border-[var(--tng-blue-100)]">
                                ...
                                <button onClick={handleSave} className="rounded-lg bg-[var(--tng-blue-600)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--tng-blue-700)] mt-2 cursor-pointer">
                                    Update PIN
                                </button>
                            </div>
                        </div>
