...
export default function CartReports() {
    return (
        <TrackngoLayout>
            <Head title="CART Reports & Analytics — TrackNGo Mati" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between shrink-0 gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-[var(--tng-slate-900)] flex items-center gap-2">
                            ...
                            CART Reports & Analytics
                        </h1>
                        <p className="mt-0.5 text-sm text-[var(--tng-slate-500)]">
                            TrackNGo Mati — ARTA compliance insights and performance metrics.
                        </p>
                    </div>
