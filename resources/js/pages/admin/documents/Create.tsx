    ...
    return (
        <TrackngoLayout
            breadcrumbs={[
                ...
                { title: 'My Documents', href: '/admin/documents' },
            ...
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="rounded-2xl border border-[var(--tng-slate-200)] bg-white shadow-sm">
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-[var(--tng-slate-100)] bg-[var(--tng-slate-50)] px-8 py-5 rounded-b-2xl">
                        ...
                        <Link href="/admin/documents" className="flex items-center gap-2 rounded-lg bg-[var(--tng-blue-600)] px-6 py-2.5 text-sm font-medium text-white shadow-md shadow-blue-600/25 transition-all hover:bg-[var(--tng-blue-700)] hover:shadow-lg">
